            ...
            <div className="pt-4 border-t border-white/10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-3 border-t border-white/10">
                <a
                  ...
                  className="px-6 py-3 rounded-full bg-white text-black font-bold text-xs uppercase tracking-wider hover:bg-gray-200 transition-all flex items-center justify-center gap-2"
                >
