        ...
        {!isOpen && (
          <div className="relative flex items-center group">
            ...
            <motion.button
              ...
              className="relative w-14 h-14 sm:w-15 sm:h-15 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-[0_8px_30px_rgba(37,211,102,0.45)] hover:shadow-[0_10px_35px_rgba(37,211,102,0.65)] cursor-pointer transition-all duration-300"
            >
              {/* Outer Ripple Ring */}
              <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-30 animate-ping" />

              {/* Official WhatsApp SVG Icon */}
              <svg className="w-8 h-8 text-white relative z-10 fill-current" viewBox="0 0 24 24">
