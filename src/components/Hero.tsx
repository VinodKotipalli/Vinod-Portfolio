  ...
  return (
    <section className={`relative min-h-screen flex flex-col justify-between pt-24 sm:pt-28 md:pt-32 pb-8 sm:pb-12 overflow-hidden transition-colors duration-300 ${
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className={`absolute bottom-10 left-1/2 -translate-x-1/2 select-none pointer-events-none text-center w-full overflow-hidden ${
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 md:px-12 flex flex-col items-start justify-center flex-grow w-full">
        ...
        <div className="mb-8 w-full">
          ...
          <h1 className={`text-3xl sm:text-5xl md:text-6xl lg:text-[4.5rem] xl:text-[5.5rem] font-black tracking-wider uppercase font-['Syne',sans-serif] mb-6 sm:mb-8 leading-none transition-colors ${
        ...
        {/* Subtitle */}
        <p className={`text-base sm:text-lg md:text-xl font-light mb-8 max-w-3xl leading-relaxed transition-colors ${
        ...
        {/* Contact Info Pills */}
        <div className={`flex flex-wrap gap-4 text-xs font-mono mb-10 pb-6 border-b w-full transition-colors ${
        ...
        <div className="flex flex-row flex-wrap items-center gap-4">
          <a
            ...
            className={`px-7 py-3.5 text-sm md:text-base rounded-full font-bold transition-all duration-300 transform hover:scale-105 flex items-center gap-2 ${
              theme === 'dark'
