      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        >
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            <span className="text-xs font-mono font-bold uppercase tracking-widest text-[#ff2a2a] bg-[#ff2a2a]/10 px-3.5 py-1.5 rounded-full border border-[#ff2a2a]/20">
              Graduation Degree
            </span>
            <span className="text-xs sm:text-sm font-mono font-bold text-white bg-white/10 px-4 py-1.5 rounded-full border border-white/20">
              Score: {education.percentage}
            </span>
          </div>

          <h3 className="text-2xl sm:text-3xl font-black text-white mb-2 font-['Kanit',sans-serif]">
            {education.degree}
          </h3>
          ...
          <p className="text-xs sm:text-sm font-mono text-white/60 mb-6">
            📍 {education.location}
          </p>

          <div className="pt-6 border-t border-white/10 flex items-center justify-between text-xs font-mono text-white/70">
