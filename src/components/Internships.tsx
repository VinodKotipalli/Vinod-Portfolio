...
const InternshipCard: React.FC<{ intern: InternshipItem; index: number }> = ({ intern, index }) => (
  ...
  >
    <div>
      ...
      <p className="text-white font-black text-sm tracking-wide mb-6 uppercase">
        {intern.organization}
      </p>
    ...
    <section id="experience" className="bg-[#ff2a2a] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-red-100 text-base md:text-lg font-bold max-w-lg mx-auto">
            Practical internships and industry roles engineering production web applications.
          </p>
        </div>
      ...
      {/* Decorative star */}
      <div className="absolute bottom-10 left-10 text-black opacity-20 animate-pulse pointer-events-none">
