...
const TagCard: React.FC<TagCardProps> = ({
  ...
  useMotionValueEvent(pathLength, 'change', (latest) => {
    ...
    // Trigger active highlight when path tip reaches card
    const triggerY = cardTopRelativeToContainer + 50;
    const lineTipY = (latest as number) * containerHeight;
      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <div
            data-aos="fade-in"
            data-aos-delay="600"
            className="hidden md:block absolute top-[1250px] left-[60%] text-3xl font-bold tracking-widest text-gray-800 rotate-6"
          >
