  ...
  >
    <div>
      <div className="flex justify-between items-start mb-6">
        ...
        <span className="text-white/40 text-xs font-mono font-bold tracking-widest uppercase py-1 px-3 border border-white/10 rounded-full">
          {category.stats}
        </span>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div data-aos="fade-up" data-aos-delay="400" className="mt-16 flex justify-center">
          ...
          >
            ...
            Follow My Visual Edits on Instagram
